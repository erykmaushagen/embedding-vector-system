...
/**
 * Einfache Main-Klasse zum Testen der VectorDataBaseConfig ohne Logging-Bibliothek.
 */
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (isConnected) {
                ...
                System.err.println("FEHLER: Datenbankverbindung konnte NICHT hergestellt werden. Bitte 'secrets.json' und Netzwerkeinstellungen prüfen.");
            }
